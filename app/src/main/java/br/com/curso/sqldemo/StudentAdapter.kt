...
class StudentAdapter : RecyclerView.Adapter<StudentAdapter.StudentViewHolder>() {
    ...
    fun addItens(itens: ArrayList<StudentModel>){
        this.stdList = itens
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = StudentViewHolder(
        LayoutInflater.from(parent.context).inflate(R.layout.card_itens_std,parent,false)
    )
    ...
    class StudentViewHolder (var view: View): RecyclerView.ViewHolder(view){
        ...
        private var name=view.findViewById<TextView>(R.id.tvIName)
        private var email=view.findViewById<TextView>(R.id.tvIEmail)
